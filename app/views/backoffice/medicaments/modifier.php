...
<head>
    ...
    <title>Modifier un médicament — Système de Gestion de Pharmacie</title>
</head>
<body>
    ...
    <form method="post" action="index.php?controller=Medicament&action=modifier&id=<?= (int) $id ?>" id="formulaire-medicament" novalidate>
        <div>
